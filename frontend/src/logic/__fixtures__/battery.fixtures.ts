...
export const batteryFixtures: BatteryFixture[] = [
  {
    ...
    expected: { voltageV: 14.8, remainingPct: 87, currentA: 8.5, cellCount: 4, source: 'BATTERY_STATUS' },
  },
  {
    ...
    expected: { voltageV: 8.4, remainingPct: null, currentA: null, cellCount: 2, source: 'BATTERY_STATUS' },
  },
  {
    ...
    // No per-cell breakdown: SYS_STATUS carries one pack voltage only.
    expected: { voltageV: 12.4, remainingPct: 64, currentA: 3, cellCount: null, source: 'SYS_STATUS' },
  },
  {
    ...
    expected: { voltageV: 11, remainingPct: null, currentA: null, cellCount: null, source: 'SYS_STATUS' },
  },
  {
    name: 'sentinel-unknown-sys-status-voltage-is-not-65-volts',
    input: { systemStatusVoltageMv: 65535, systemStatusRemainingPct: 40 },
    expected: { voltageV: null, remainingPct: 40, currentA: null, cellCount: null, source: 'SYS_STATUS' },
  },
  {
    ...
    expected: { voltageV: 12, remainingPct: null, currentA: null, cellCount: null, source: 'SYS_STATUS' },
  },
  {
  ...
  },
  {
    ...
    expected: { voltageV: 12, remainingPct: null, currentA: -2.5, cellCount: null, source: 'SYS_STATUS' },
  },
  {
    name: 'remaining-without-voltage-is-still-a-reading',
    input: { systemStatusRemainingPct: 15 },
    expected: { voltageV: null, remainingPct: 15, currentA: null, cellCount: null, source: 'SYS_STATUS' },
  },
  {
    ...
    expected: { voltageV: null, remainingPct: 80, currentA: null, cellCount: null, source: 'BATTERY_STATUS' },
  },
  {
    name: 'zero-percent-is-a-reading-not-an-absence',
    input: { systemStatusVoltageMv: 9600, systemStatusRemainingPct: 0 },
    expected: { voltageV: 9.6, remainingPct: 0, currentA: null, cellCount: null, source: 'SYS_STATUS' },
  },
  {
