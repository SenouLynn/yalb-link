...
captures in `docs/temp/evidence/t021/` are optional and may be pruned.
...
Artifacts: [stopped session](../../temp/evidence/t021/stopped.json), [before recreation](../../temp/evidence/t021/before.json),
[after recreation](../../temp/evidence/t021/after.json), [comparison](../../temp/evidence/t021/comparison.json).
